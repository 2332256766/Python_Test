...
from MachineL_The_4_week_practise.displayData import displayData
from MachineL_The_4_week_practise.nnCostFunction import nnCostFunction
from MachineL_The_4_week_practise.sigmoidGradient import sigmoidGradient
from MachineL_The_4_week_practise.randlnitializeWeights import randInitializeWeights
from MachineL_The_4_week_practise.checkNNGradients import checkNNGradients
from scipy.optimize import minimize
from MachineL_The_4_week_practise.predict import predict
...
res = minimize(costFunction, initial_nn_params, method='CG', jac=True, options={'maxiter': 10})
nn_params = res.x
